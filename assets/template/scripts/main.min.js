...
var App={options:{groupSelector:'[data-select="group"]',tarifsGroupsContainer:".tarifs-group",tarifsContainer:".tarifs",tarifsContainerVisibleClass:"tarifs--visible",tarifsSelector:'[data-select="tarif"]'},init:function(){},screenBackward:function(){},screenForward:function(){}};$(document).ready(function(){$("body").on("click",App.options.groupSelector,function(t){t.preventDefault();var i=$(this).data("group");$.post("index.php",{q:"GetTarifs",group:i},function(t){$(App.options.tarifsContainer).html(t),$(App.options.tarifsGroupsContainer).hide(),$(App.options.tarifsContainer).addClass(App.options.tarifsContainerVisibleClass)})}),$("body").on("click",App.options.tarifsSelector,function(t){t.preventDefault();var i=$(this).data("id"),o=$(this).data("group");$.post("index.php",{q:"GetTarif",id:i,group:o},function(t){console.log(t)})}),App.init()});