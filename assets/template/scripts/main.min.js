...
var App={options:{groupSelector:'[data-select="group"]'},init:function(){},tarifGroupSelect:function(){}};$(document).ready(function(){$("body").on("click",App.options.groupSelector,function(o){o.preventDefault();var t=$(this).data("group");$.post("index.php",{q:"GetTarifs",group:t},function(o){console.log(o)})}),App.init()});