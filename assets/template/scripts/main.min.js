...
var App={options:{screen:["group","GetTarifs","GetTarif"]},init:function(){},screenBackward:function(e){console.log('[data-select-parent="'+App.options.screen[App.options.screen.indexOf(e)]+'"]'),$('[data-select-parent="'+App.options.screen[App.options.screen.indexOf(e)+1]+'"]').hide(),$('[data-select-parent="'+App.options.screen[App.options.screen.indexOf(e)]+'"]').show()},screenForward:function(e){$('[data-select-parent="'+App.options.screen[App.options.screen.indexOf(e)-1]+'"]').hide(),$('[data-select-parent="'+App.options.screen[App.options.screen.indexOf(e)]+'"]').show()}};$(document).ready(function(){$("body").on("click","[data-select]",function(e){e.preventDefault();var n=$(this).data("group"),t=$(this).data("action"),p=$(this).data("id");$.post("index.php",{q:t,group:n,id:p},function(e){console.log(App.options.screen[App.options.screen.indexOf(t)-1]),$('[data-select-parent="'+t+'"]').html(e),App.screenForward(t)})}),$("body").on("click","[data-backward]",function(e){e.preventDefault(),App.screenBackward($(this).data("backward"))})});